...
<html>
  ...
  <body>
  <form action="servlet/AddMeetingServer" method="post" onsubmit="return check();">
  	<table border="0" align="center" cellspacing="1" bgcolor="#336699" width="50%" >
	    <tr><th align="center" colspan="2" style="font-size: 16px;height: 30px;">添加会议服务人员</th></tr>
	    ...
	    <tr><td bgcolor="#FFFFFF"><font color="red">*</font>邮箱：</td><td bgcolor="#FFFFFF"><input name="email" id="email" type="text"/></td></tr>
	   	<tr><td bgcolor="#FFFFFF"><font color="red">*</font>密码：</td><td bgcolor="#FFFFFF"><input name="password" id="password" type="password"/></td></tr>
	    <tr><td bgcolor="#FFFFFF">手机号码：</td><td bgcolor="#FFFFFF"><input name="mobnumber" id="mobnumber" type="text"/></td></tr>
