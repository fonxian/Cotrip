...
<html>
  ...
  <body>
    ...
    <tr><th align="center" colspan="2" style="font-size: 16px;height: 30px;">添加会议公告</th></tr>
    ...
    <tr><td colspan="2" align="center"><input type="hidden" name="type" value="P"/><input type="hidden" name="meetingID" value="${meeting.meetingID }"/>
