              ...
              <td height="80" colspan="3" align="left">&nbsp;&nbsp;
                <table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
                  <tr bgcolor="#F1F1F1">
                    ...
                    <td height="26"><input name="name" type="text" class="inputbox" id="name" value="${manager.managername }"></td>
                  </tr>
				  <tr bgcolor="#F1F1F1">
                    <td height="26" align="right">电话　　</td>
                    <td height="26"><input name="mobnumber" type=text class="inputbox" id="mobnumber" value="${manager.mobnumber }">
                    <input name="mID" type=hidden  id="mID" value="${manager.managerID}">
                    </td>
                  </tr>
                </table></td>
              </tr>
