...
<% 
   ArrayList<MeetingJoin> list=(ArrayList<MeetingJoin>)request.getAttribute("userlist");
...
<script language="javascript" type="text/javascript">
  ...
  <div id="div_side">
	<%@ include file="side.inc"%>
      ...
      <div id="div_center">
      <div class="side_title" align="center"><h2 align="center"><span >发布计划</span></h2></div>
       <form name="form1" method="post" action="<%=path%>/planServlet?what=createPlan"  onsubmit="return Validation();" >         
          <table width="100%" border="1px" cellpadding="5px"
						cellspacing="0px" bordercolor="#B1B1E6" style="text-align:center">
           <tbody>
           <tr>
             <td width="318" class="test1"><div align="right"><font color='red'>*</font>姓&nbsp;&nbsp;&nbsp;&nbsp;名:</div></td>
             <td width="822" align="left"><input type="text" id="username" name="username" value="${curuser.username }"><span id="nameyan"></span></td>
           </tr>
           <tr>
             <td class="test1"><div align="right"><font color='red'>*</font>出发时间:</div></td>
             <td align="left"><input type="text" name="starttime" id="starttime" readonly="true"/><input name="button" value="&nbsp;*&nbsp;"
           ...
           <tr>
             ...
             <td align="left"><input type="text" name="overtime" id="overtime" readonly="true" /><input name="button" value="&nbsp;*&nbsp;"
           ...
           <tr>
             ...
             <td align="left"><input type="text" class="cityinput" id="startaddress" name="startaddress" value="城市名" ><span id="startaddressyan"></span></td>
           </tr>
           <tr>
             <td class="test1" ><div align="right">到达地点:</div></td>
             <td align="left"><input type="text" id="overaddress" name="overaddress" value="<%=meeting.getHoldcity()%>" readonly="true"> </td>
           </tr>
                      <tr>
             ...
             <td align="left"><select name="method" size="1">
                            ...
                            <option value="船渡">船渡</option>
                            <option value="其它">其它</option>
             </select>           </tr>
           <tr>
             <td class="test1"><div align="right">航班(车次):</div></td>
             <td align="left"><input type="text" id="tfnumber" name="tfnumber" ><span id="tfnumberMsg"></span>           </tr>
           <tr>
             <td class="test1"><div align="right"><font color='red'>*</font>邮&nbsp;&nbsp;&nbsp;&nbsp;箱:</div></td>
             <td align="left"><input type="text" id="email" name="email" value="<%=user.getEmail()%>" onBlur="checkEmail()" ><span id="emailyan"></span></td>
           </tr>
           <tr>
             <td class="test1"><div align="right"><font color='red'>*</font>电&nbsp;&nbsp;&nbsp;&nbsp;话:</div></td>
             <td align="left"><input type="text" id="number" name="number" value="${user.mobnumber }" onBlur="checkNumber()" ><span id="numberyan"></span></td>
           </tr>
           <tr>
             <td class="test1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <div align="right">备&nbsp;&nbsp;&nbsp;&nbsp;注:</div></td>
             <td align="left"><textarea id="remark" name="remark" cols="40" rows="4"></textarea></td>
           </tr>
           <tr>
             <td class="test1">&nbsp;
           ...
           <td><select id="ispublic" name="ispublic" size=1 onChange="selected()">
               <option value ="N">不公开</option>
               <option value ="Y">公开</option>      
           </select>
           标记“<font color='red'>*</font>”为必须填写的内容;           </td>
           </tr>
           <tr>
