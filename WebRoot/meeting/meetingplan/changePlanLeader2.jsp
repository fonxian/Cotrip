...
// ArrayList<User> list=userImp.getAllUser();
String planID=request.getParameter("planID");
String userID=(String)request.getAttribute("userID");
ArrayList<Response> list=ResponseImp.getAllResponseByPlanID(planID);
%>
...
<form action="updatePlanServlet?what=changeother&planID=<%=planID%>" method="post" onSubmit="return selected();" style="padding-left:25px;">
     <h2><span>你的计划已经被其他用户响应，请在这些用户选择一名拥有原计划</span></h2>
