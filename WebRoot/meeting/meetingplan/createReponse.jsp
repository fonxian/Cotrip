  ...
  <div id="div_side">
	<%@ include file="side.inc"%>
     ...
     <div class="side_title">
      <h2 align="center"><span >创建响应</span></h2></div>
       <form name="form1" method="post" action="<%=path%>/otherPlanServlet?what=sharedplan"  onsubmit="return Validation();" >
           ...
           <tr>
             ...
             <td align="left"><input type="text" id="username" name="username"  value="${user.username }" ><span id="nameyan"></span></td>
           </tr>
           <tr>
             <td align="left"><div align="right"><font color="red">*</font>邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱:</div></td>
             <td align="left"><input type="text" id="email" name="email"  value="${user.email }" ><span id="emailyan"></span></td>
           </tr>
           <tr>
             <td align="left"><div align="right"><font color="red">*</font>电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话:</div></td>
             <td align="left"><input type="text" id="number" name="number"  value="${user.mobnumber }" ><span id="numberyan"></span></td>
           </tr>
           <tr>
             <td align="left"><div align="right">备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注:</div></td>
             <td align="left"><input type="textarea" id="remark" name="remark"></td>
           </tr>
           <tr>
             <td align="left"><div align="right">公&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;开:</div></td>
             <td align="left"><select id="status" name="status" size="1">
