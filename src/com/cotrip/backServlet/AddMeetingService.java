...
public class AddMeetingService extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println(serviceperson+"电话"+contactnumber+"城市"+city+country+remark+meetingID);
